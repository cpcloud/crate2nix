  ...
  crates = {
      ...
      = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "mio-named-pipes 0.1.6 (registry+https://github.com/rust-lang/crates.io-index)";
            optional = true;
            target = {target, features}: target."windows";
          }
          {
        ...
        resolvedDefaultFeatures = [ "default" "io-driver" "lazy_static" "libc" "mio" "mio-named-pipes" "mio-uds" "process" "rt-core" "signal" "signal-hook-registry" "winapi" ];
      };
    ...
    "winapi 0.3.8 (registry+https://github.com/rust-lang/crates.io-index)"
      = rec {
        ...
        resolvedDefaultFeatures = [ "consoleapi" "errhandlingapi" "fileapi" "handleapi" "ioapiset" "minwinbase" "minwindef" "namedpipeapi" "ntdef" "ntsecapi" "processenv" "profileapi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincon" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
